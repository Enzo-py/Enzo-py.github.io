var Toolbox=(()=>{var J=Object.defineProperty;var yt=Object.getOwnPropertyDescriptor;var kt=Object.getOwnPropertyNames;var Et=Object.prototype.hasOwnProperty;var E=(p,t)=>{for(var e in t)J(p,e,{get:t[e],enumerable:!0})},Ct=(p,t,e,s)=>{if(t&&typeof t=="object"||typeof t=="function")for(let i of kt(t))!Et.call(p,i)&&i!==e&&J(p,i,{get:()=>t[i],enumerable:!(s=yt(t,i))||s.enumerable});return p};var St=p=>Ct(J({},"__esModule",{value:!0}),p);var Tt={};E(Tt,{ActionItem:()=>q,CheckboxItem:()=>A,ContextMenu:()=>N,DataTable:()=>C,EditableText:()=>M,LoadingScreen:()=>U,MenuItem:()=>S,Navigator:()=>z,PopUp:()=>T,SeparatorItem:()=>j,Slider:()=>F,Toast:()=>W,context_menu:()=>X,editable_text:()=>K,loading_screen:()=>ot,navigator:()=>V,pop_up:()=>Y,slider:()=>nt,table:()=>it,toast:()=>rt});var X={};E(X,{ActionItem:()=>q,CheckboxItem:()=>A,ContextMenu:()=>N,MenuItem:()=>S,SeparatorItem:()=>j});var at=`.context-menu{position:fixed;z-index:9999;min-width:180px;max-width:320px;background:#fff;border:1px solid #e5e7eb;border-radius:8px;box-shadow:0 10px 30px rgba(0,0,0,.12);padding:6px 0;font:14px/1.4 system-ui,-apple-system,Segoe UI,Roboto}\r
...
${r}
${a}
`;this._download(`${this.filename}.md`,n,"text/markdown;charset=utf-8")}async _copy_csv(t){let{headers:e,values:s}=this._collect_flat(t,!0),i=this._to_delim(e,s,",");try{await navigator.clipboard.writeText(i)}catch{let o=document.createElement("textarea");o.value=i,document.body.appendChild(o),o.select();try{document.execCommand("copy")}finally{o.remove()}}}_export_json(t){let{paths:e,values:s}=this._collect_for_json(t),i=s.map(r=>this._nest_row(e,r)),o=JSON.stringify(i,null,2);this._download(`${this.filename}.json`,o,"application/json;charset=utf-8")}_collect_flat(t,e){let s=this.table.model.get_columns(),i=this.table.model.get_flat_columns(),r=this._leaf_paths(s,this.key_source).map(c=>c.join(this.path_sep));if(this.table.mode==="virtual"){let c=this.table.model;c.apply();let _;t==="all"?_=c.get_rows("raw"):t==="filtered"?_=c.get_rows("view"):_=c.get_rows("page");let h=c.formatters,d=_.map(u=>i.map(b=>{let m=u[b.id];if(!e)return m;let f=h.get(b.id);return f?f(m,u):m??""}));return{headers:r,values:d}}let a=this.table._adopt_table.tBodies[0],n;t==="all"?n=[...a.rows]:t==="filtered"?n=[...a.rows].filter(c=>c.dataset.hidden!=="true"):n=[...a.rows].filter(c=>c.dataset.hidden!=="true"&&c.style.display!=="none");let l=n.map(c=>{let _=[...c.cells];return i.map((h,d)=>_[d]?.textContent?.trim()??"")});return{headers:r,values:l}}_collect_for_json(t){let e=this.table.model.get_columns(),s=this.table.model.get_flat_columns(),i=this._leaf_paths(e,this.json_key_source);if(this.table.mode==="virtual"){let n=this.table.model;n.apply();let l;t==="all"?l=n.get_rows("raw"):t==="filtered"?l=n.get_rows("view"):l=n.get_rows("page");let c=l.map(_=>s.map(h=>_[h.id]));return{paths:i,values:c}}let o=this.table._adopt_table.tBodies[0],r;t==="all"?r=[...o.rows]:t==="filtered"?r=[...o.rows].filter(n=>n.dataset.hidden!=="true"):r=[...o.rows].filter(n=>n.dataset.hidden!=="true"&&n.style.display!=="none");let a=r.map(n=>{let l=[...n.cells];return s.map((c,_)=>l[_]?.textContent?.trim()??"")});return{paths:i,values:a}}_leaf_paths(t,e){let s=[],i=r=>e==="id"?r.id??r.label??"col":r.label??r.id??"col",o=(r,a=[])=>{for(let n of r||[])if(n.children&&n.children.length){let l=e==="id"?n.id??n.label??"":n.label??n.id??"";o(n.children,l?[...a,l]:[...a])}else s.push([...a,i(n)])};return o(t,[]),s}_nest_row(t,e){let s={};for(let i=0;i<t.length;i++){let o=t[i],r=s;for(let n=0;n<o.length-1;n++){let l=o[n]??"";(!(l in r)||typeof r[l]!="object"||r[l]===null)&&(r[l]={}),r=r[l]}let a=o[o.length-1]??"value";r[a]=e[i]}return s}_to_delim(t,e,s){let i=a=>(a=a==null?"":String(a),/[\"\n,]/.test(a)?`"${a.replace(/"/g,'""')}"`:a),o=t.map(i).join(s),r=e.map(a=>a.map(n=>i(n)).join(s)).join(`
`);return`${o}
